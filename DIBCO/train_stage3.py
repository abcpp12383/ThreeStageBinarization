...
def unetplusplus_train(epochs, gpu, base_model_name, encoder_weights, generator_lr, discriminator_lr, lambda_bce,
    ...
    for epoch in range(epochs):
        ...
        for eval_idx, image_test in enumerate(image_test_list):
            ...
            image_patches, poslist = get_image_patch(image, 224, 224, overlap=0.1, is_mask=False)
            color_patches = []
    ...
    torch.save(patch_model.state_dict(), weight_path + '/unetplusplus_patch_%d_%.4f.pth' % (epoch + 1, total_fmeasure))
...
if __name__ == "__main__":
    ...
    # data set
    parser.add_argument('--image_train_dir', type=str, default='./UnetPlusPlus/predicted_image_for_stage3_dibco_UnetPlusPlus_e_10_bs_16/train/patch/image/', help='patched stage2 prdiction image train dir')
    parser.add_argument('--mask_train_dir', type=str, default='./UnetPlusPlus/predicted_image_for_stage3_dibco_UnetPlusPlus_e_10_bs_16/train/patch/mask/', help='patched stage2 prdiction mask train dir')
    parser.add_argument('--image_test_dir', type=str, default='./UnetPlusPlus/predicted_image_for_stage3_dibco_UnetPlusPlus_e_10_bs_16/test/', help='stage2 prdiction image test dir')
    parser.add_argument('--mask_test_dir', type=str, default='./DIBCO/Testset/mask/', help='original mask test dir')
