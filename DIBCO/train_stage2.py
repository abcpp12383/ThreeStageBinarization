...
from method_NA_LLandNorm import Dataset_Return_Four
...
if __name__ == "__main__":
    ...
    # data set
    parser.add_argument('--image_train_dir', type=str, default='./DIBCO/DIBCO_resize_224/Trainset/image/', help='patched image train dir')
    parser.add_argument('--mask_train_dir', type=str, default='./DIBCO/DIBCO_resize_224/Trainset/mask/', help='patched mask train dir')
    parser.add_argument('--image_test_dir', type=str, default='./DIBCO/Testset/image/', help='original image test dir')
