...
def main():
    image_dir = '../ThreeStageBinarization/DIBCO_resize_256/Trainset/image/'
    rename_dir = '../ThreeStageBinarization/image_patches/256X256_rename/'
    gray_dir = '../ThreeStageBinarization/image_patches/256X256_gray/'
    turn_img_to_gray(image_dir,rename_dir,gray_dir)
    split_3_colors = '../ThreeStageBinarization/image_patches/256X256_split_colors/'
    image_split_3_colors(image_dir,split_3_colors)
    DWT_4_image_dir = '../ThreeStageBinarization/image_patches/256X256_DWT_image/'
    resize_LL_image_dir = '../ThreeStageBinarization/image_patches/256X256_big_LL_image/'
    LL_normalized_dir = '../ThreeStageBinarization/image_patches/256X256_LL_normalized/'
