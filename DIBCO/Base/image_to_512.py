...
def main(argv=None):
    ...
    image_dir = ['./DIBCO/Trainset/image/', './DIBCO/Testset/image/']
    mask_dir = ['./DIBCO/Trainset/mask/', './DIBCO/Testset/mask/']
    ...
    image_save_dir = ['./DIBCO/DIBCO_resize_512/Trainset/image/', './DIBCO/DIBCO_resize_512/Testset/image/']
    mask_save_dir = ['./DIBCO/DIBCO_resize_512/Trainset/mask/', './DIBCO/DIBCO_resize_512/Testset/mask/']
