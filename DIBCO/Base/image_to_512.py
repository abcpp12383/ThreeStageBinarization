...
def main(argv=None):
    ...
    image_dir = ['../ThreeStageBinarization/DIBCO/Trainset/image/', '../ThreeStageBinarization/DIBCO/Testset/image/']
    mask_dir = ['../ThreeStageBinarization/DIBCO/Trainset/mask/', '../ThreeStageBinarization/DIBCO/Testset/mask/']
    ...
    image_save_dir = ['../ThreeStageBinarization/DIBCO_resize_512/Trainset/image/', '../ThreeStageBinarization/DIBCO_resize_512/Testset/image/']
    mask_save_dir = ['../ThreeStageBinarization/DIBCO_resize_512/Trainset/mask/', '../ThreeStageBinarization/DIBCO_resize_512/Testset/mask/']
