...
def main(argv=None):
    image_dir = './DIBCO/Trainset/image/'
    mask_dir = './DIBCO/Trainset/mask/'
    ...
    image_save_dir = './DIBCO/DIBCO_resize_224/Trainset/image/'
    mask_save_dir = './DIBCO/DIBCO_resize_224/Trainset/mask/'
