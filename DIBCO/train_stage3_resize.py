...
if __name__ == "__main__":
    ...
    # data set
    parser.add_argument('--image_train_dir', type=str, default='./DIBCO/DIBCO_resize_512/Trainset/image', help='512 resized image train dir')
    parser.add_argument('--mask_train_dir', type=str, default='./DIBCO/DIBCO_resize_512/Trainset/mask', help='512 resized mask train dir')
